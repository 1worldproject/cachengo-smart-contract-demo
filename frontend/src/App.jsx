...
function App() {
  ...
  const handleAIComplete = (data) => {
    ...
    // Check for the template ID in either the new format (type) or old format (suggestedTemplate)
    const templateId = data.type || data.suggestedTemplate
    ...
    // Fallback to template selection if no suggestion
    setStep('template')
  }
